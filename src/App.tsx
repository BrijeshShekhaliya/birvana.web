...
function ScrollToTop() {
  ...
  useEffect(() => {
    ...
    if (pathname.startsWith('/blog/')) {
      ...
      if (post) {
        updateSEO({
          title: `${post.title} | Birvana Music Blog`,
          description: post.description,
          canonicalUrl: `https://birvana.indevs.in/blog/${post.slug}`,
        });
      }
    } else {
      switch (pathname) {
        ...
        case '/blog':
          updateSEO({
            title: 'Birvana Blog — Tech Guides & Lossless Audio Insights',
            description: 'Read the official Birvana Music App blog. Discover developer insights, caching strategies, and audiophile guides for high-fidelity Android streaming.',
            canonicalUrl: 'https://birvana.indevs.in/blog',
          });
          break;
        case '/login':
          updateSEO({
